...
def posterior(x, n, P, Pr):
    """ Function to calculate the posterior of x
    Args:
    ...
    Returns
        (numpy.ndarray) the posterior of each probability in P
    """
    __validate_params(x, n, P, Pr)
    intersection = __intersection(x, n, P, Pr)
    marginal = __marginal(x, n, P, Pr)
    return intersection / marginal


def __marginal(x, n, P, Pr):
