...
def mat_mul(mat1, mat2):
    ...
    # The result matrix will have as many rows as the first matrix
    for j in range(n_rows_mat1):
        ...
        for k in range(n_cols_mat2):
            ...
            # n represents the number of terms we are going to multiply and add
            # n == n_cols_mat1 && n == n_rows_mat2
            n = n_cols_mat1
